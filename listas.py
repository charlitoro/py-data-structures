from structures.nodos import NodoLSE
from structures.validación import validar_dato, validar_pos
from structures.iterador import IteradorListaC, IteradorLista
...
# Clase para el manejo de listas circulares simples enlazadas
class LCSE:
    # Inicializacion
    def __init__(self):
        ''' Documentación:
